...
const process = [
  {
    ...
    desc: "Teams are assigned problem statements through a Lottery System. Teams must work only on the assigned problem.",
  },
  {
    icon: "🔍",
    title: "Research & Analysis",
    desc: "Study the background, analyze existing solutions, identify gaps, and support analysis with reliable data.",
  },
  {
    icon: "💡",
    title: "Solution Development",
    desc: "Develop the concept, implementation approach, and expected sustainability impact.",
  },
];
  ...
  <div className="min-h-screen pt-24">
    ...
    <section className="py-16 px-4 bg-muted/20">
      <div className="container mx-auto max-w-3xl">
        ...
        <SectionHeading
          title="Deliverables"
          subtitle="Report length: 3–5 pages"
        />
